...
class ResetPassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(padding: EdgeInsets.all(MySizes.defaultSpace),
        child: Column(
          children: [
            //image
            Image(image:  AssetImage(MyImages.emailVerfication),width: MyHelperFunctions.screenWidth()*0.6,height:MyHelperFunctions.screenHeight()*0.4 ),
            const SizedBox(
